package me.millen.airdrops.injection;
/*
...
public class Injector{
	...
	public Injector setChances(double chances){
		...
		lore.removeIf(line -> line.startsWith(ChatColor.GOLD +"Chance: "));
		lore.add(ChatColor.GOLD +"Chance: " +ChatColor.YELLOW +chances +"%");
		meta.setLore(lore);
	...
	public void toggleDestroy(){
		if(hasKey("destroy"))
			...
			set("destroy", String.valueOf(true));
	}
